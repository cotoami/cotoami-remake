...
fn pagination() -> Result<()> {
    ...
    // when
    let _ = ds.post_coto("1", None, None, None, &root_cotonoma, &operator)?;
    let paginated = ds.recent_cotos(None, Some(&root_cotonoma.uuid), 2, 0)?;
    ...
    // when
    let _ = ds.post_coto("2", None, None, None, &root_cotonoma, &operator)?;
    let paginated = ds.recent_cotos(None, Some(&root_cotonoma.uuid), 2, 0)?;
    ...
    // when
    let _ = ds.post_coto("3", None, None, None, &root_cotonoma, &operator)?;
    let paginated = ds.recent_cotos(None, Some(&root_cotonoma.uuid), 2, 0)?;
