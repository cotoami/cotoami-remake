...
fn graph() -> Result<()> {
    ...
    let (coto1, _) = ds.post_coto("coto1", None, None, &root, &opr)?;
    ...
    let (coto2, _) = ds.post_coto("coto2", None, None, &root, &opr)?;
    ...
    let (coto3, _) = ds.post_coto("coto3", None, None, &root, &opr)?;
    ...
    let (coto4, _) = ds.post_coto("coto4", None, None, &root, &opr)?;
