...
fn crud_operations() -> Result<()> {
    ...
    let (coto1, _) = ds.post_coto("coto1", None, None, &root_cotonoma, &operator)?;
    let (coto2, _) = ds.post_coto("coto2", None, None, &root_cotonoma, &operator)?;
    let (coto3, _) = ds.post_coto("coto3", None, None, &root_cotonoma, &operator)?;
    let (coto4, _) = ds.post_coto("coto4", None, None, &root_cotonoma, &operator)?;
