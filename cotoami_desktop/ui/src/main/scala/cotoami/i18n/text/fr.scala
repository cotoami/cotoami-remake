...
object fr extends Text {
  ...
  val OpenBrowser = "Ouvrir le Navigateur"
  val CloseBrowser = "Fermer le Navigateur"
  ...
  val SelectCotonoma_newCotonoma = "Nouveau cotonoma"
  ...
  val BrowserShell_addressPlaceholder = "Rechercher ou saisir une URL"
