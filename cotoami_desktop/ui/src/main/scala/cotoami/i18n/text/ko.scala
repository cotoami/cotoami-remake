...
object ko extends Text {
  ...
  val BrowserShell_downloads = "파일 다운로드"
  val BrowserShell_downloadsEmpty = "다운로드한 파일이 없습니다."
  val BrowserShell_downloadStatusDownloading = "다운로드 중..."
  val BrowserShell_downloadStatusFinished = "다운로드 완료"
  val BrowserShell_downloadStatusFailed = "다운로드 실패"
  val BrowserShell_addressPlaceholder = "검색어 또는 URL 입력"
