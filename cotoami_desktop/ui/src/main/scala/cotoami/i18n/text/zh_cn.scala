...
object zh_cn extends Text {
  ...
  val ModelessNodeProfile_title = "节点配置文件"
  ...
  val BrowserShell_downloads = "文件下载"
  val BrowserShell_downloadsEmpty = "暂无已下载文件。"
  val BrowserShell_downloadStatusDownloading = "正在下载..."
  val BrowserShell_downloadStatusFinished = "已下载"
  val BrowserShell_downloadStatusFailed = "下载失败"
  val BrowserShell_addressPlaceholder = "搜索或输入 URL"
  ...
  val BrowserShell_openInWindow = "在窗口中打开"
  val BrowserShell_close = "关闭"
}
