...
object de extends Text {
  ...
  val CloseBrowser = "Browser schließen"
  ...
  val PaneStock_map_openModeless = "Im Fenster offnen"
  ...
  val ModelessSubcoto_title = "Neues Sub-Coto"
  val ModelessNodeProfile_title = "Knoten-Profil"
  ...
  val BrowserShell_addressPlaceholder = "Suchen oder URL eingeben"
