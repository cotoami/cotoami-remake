...
object en extends Text {
  ...
  val PostTo = "Post to"
  def Edit(what: String): String = s"Edit ${what}"
  ...
  val PaneStock_map_openModeless = "Open in Window"
  ...
  val ModelessSubcoto_title = "New Sub-coto"
  val ModelessNodeProfile_title = "Node Profile"
  val ModelessNodeProfile_selfNode = "You"
  val ModelessNodeProfile_switched = "switched"
  ...
  val BrowserShell_downloads = "File Downloads"
  val BrowserShell_downloadsEmpty = "No downloaded files."
  val BrowserShell_downloadStatusDownloading = "Downloading..."
  val BrowserShell_downloadStatusFinished = "Downloaded"
  val BrowserShell_downloadStatusFailed = "Download failed"
