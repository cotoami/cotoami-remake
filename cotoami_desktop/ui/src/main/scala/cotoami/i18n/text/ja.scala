...
object ja extends Text {
  ...
  val BrowserShell_downloads = "ファイルのダウンロード"
  val BrowserShell_downloadsEmpty = "ダウンロードしたファイルはありません。"
  val BrowserShell_downloadStatusDownloading = "ダウンロード中..."
  val BrowserShell_downloadStatusFinished = "ダウンロード済み"
  val BrowserShell_downloadStatusFailed = "ダウンロード失敗"
